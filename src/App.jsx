    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">[Shivani Didi]</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">[Shivani Didi]'s</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — [Younger BRO Sarthak] 💖</h2>
